...
/**
 * This is a model class for Employee's Work Shift Report
...
public class WorkShiftReportModel extends AuditModel {

  /**
   * This Serial UID number.
   */
  private static final long serialVersionUID = -2638540907792353151L;
  ...
  public String toString() {
    return "WorkShiftReportModel [workshiftId=" + workshiftId + ", workshiftType=" + workshiftType
